...
using ProjetoAula05_.Repositories; 
using System;
using System.Collections.Generic;
using System.Data.SqlClient;
using System.Text;

namespace ProjetoAula05_.Controllers
{
    public class EmpresaController
    {
        //atributo privado
        private string connectionString = @"Data Source=(localdb)\MSSQLLocalDB;
                                            Initial Catalog=BDAula05;
        ...
        public void CadastrarEmpresa()
        {
            ...
            catch (SqlException e) //somente para erros de SQL (banco)
            {
                ...
                if (e.Number == 2627)
                {
                    Console.WriteLine("Verifique a Razão Social ou CNPJ informados. Estes valores já existem na base de dados.");
                }
                else if (e.Number == 8152)
                {
                    Console.WriteLine("O limite de caracteres permitido para o campo foi excedido.");
                }
            }
